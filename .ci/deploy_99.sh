...
description="Deploy the new AE (base, cit, devel, tools, worker)"
...
then
    ...
    docker save -o ${tempfn} esp_cit:${cit_version} esp_devel:${version} esp_py:${py_version} esp_tools:${version} esp_worker:latest
